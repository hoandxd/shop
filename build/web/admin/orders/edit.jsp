                            ...
                            <div class="card-body">
                                <form action="EditOrderServlet" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="code" value="${order.code}" disabled="" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Status</label>
                                        <select name="status" class="form-control">
                                            <option <c:if test="${order.status == 'pending'}">selected</c:if> value="pending">Pending</option>
                                            <option <c:if test="${order.status == 'shipping'}">selected</c:if> value="shipping">Shipping</option>
                                            <option <c:if test="${order.status == 'canceled'}">selected</c:if> value="canceled">Canceled</option>
