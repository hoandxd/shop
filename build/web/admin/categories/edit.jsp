                            ...
                            <div class="card-body">
                                <form action="EditCategoryServlet" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="name" value="${category.name}" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Desc</label>
                                        <input name="description" value="${category.desc}" type="text" class="form-control" id="exampleInputPassword1" placeholder="Password">
                                    </div>
                                    <br/>
